<?php
/* Smarty version 5.4.0, created on 2025-02-20 22:32:40
  from 'file:crearServicioRealizado.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.0',
  'unifunc' => 'content_67b79f78cd8953_35147796',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b4dcb18ddb9e9da45fd47a3a1453ff60c0f740ed' => 
    array (
...
function content_67b79f78cd8953_35147796 (\Smarty\Template $_smarty_tpl) {
...
>
        document.getElementById('formServicioRealizado').onsubmit = function(event) {
            ...
            .catch(() => {
                ...
                const mensajeDiv = document.getElementById('mensaje');
                mensajeDiv.innerHTML = 'Error al registrar el servicio realizado. Inténtalo más tarde.';
                mensajeDiv.style.display = "block";
                mensajeDiv.className = "alert alert-danger";
            });
        };
